...
export const reservationValidation = [
  ...
  body('subType').isIn(['business_basic', 'business_high', 'business_corporate', 'experience_start', 'experience_classic', 'experience_celebration']).withMessage('Invalid subType'),
